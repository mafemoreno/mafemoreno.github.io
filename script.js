function generate(){
	...
	document.getElementById('result').innerHTML = "<h1>Crea un personaje con estos rasgos:</h1><div class='alert alert-success'><h2>Es "+genero[rand_genero]+", su tono de piel es "+color[rand_color]+", sus ojos son "+ojos[rand_ojos]+" y tiene "+tiene[rand_tiene]+". Su personalidad es "+actitud[rand_actitud]+" y su sueño es "+quiere[rand_quiere]+".</h2></div>";
